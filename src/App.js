			...
			<div id="page">
				<div class="container">
					...
					<div class="row justify-content-center align-items-center">
						<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12" id="title"><p class="text-center">STOP tweakin' (2018)</p></div>
					</div>
					...
					<div class="row justify-content-center align-items-center">
						<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12" id="title1">
					...
					<div class="row justify-content-center align-items-center">
						<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12" id="title2">
							<p class="text-center">me + ur moms in the background</p>
						</div>
					</div>

					<div class="row justify-content-center align-items-center">
						<img class="col-xs-4 col-sm-4 col-md-4 col-lg-4 col-xl-4" id="me" src={me} alt="">
						</img>
					</div>
