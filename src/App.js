		...
		return (
			<div id="page">
				<div class="container">
					...
					<div class="row">
						<div class="col col-push-12" id="title"><p class="text-center">STOP tweakin' (2018)</p></div>
					</div>
					...
					<div class="row justify-content-center align-items-center">
						<div class="col" id="title2">
							<p class="text-center">me + ur moms in the background</p>
						</div>
					</div>

					<div class="row justify-content-center align-items-center">
						<img class="col-4" id="me" src={me} alt="">
						</img>
					</div>
